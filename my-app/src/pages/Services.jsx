       ...
       return(
          ...
          <div className="">
                     ...
                     <div className={`w-[50%] flex flex-col text-white items-center justify-center mt-40 fixed z-5 ${isVisible ? "block" : "hidden"}`}>
                                ...
                                <p className="w-full text-center mt-4 text-xl">We offer cutting-edge solutions across all major areas of web development, covering the complete lifecycle — from planning, designing, and innovation to development, testing, deployment, and maintenance.
Our expertise spans frontend, backend, full stack, UI/UX design, and e-commerce development, ensuring end-to-end delivery of seamless and scalable digital products.</p>
                                <Link to="/contactus" className="flex items-center p-2 px-4 bg-blue-400 hover:bg-gray-400 rounded-full gap-x-2 mt-6">
                                          <FaPlay />
                                          <p className="text-l">ENQUIRE KNOW</p>
                                </Link>
                     </div>
                    </div>
